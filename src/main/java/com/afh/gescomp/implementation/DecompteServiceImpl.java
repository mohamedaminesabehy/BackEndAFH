...
public class DecompteServiceImpl implements DecompteService {
    ...
    public DecompteResponse insertDecompte(Long numMarche, java.sql.Date datePiece, Long idTypeDec, Long numEtape, Short soldeAvance) {
        try {
            ...
            logger.error("Erreur lors de l'insertion du décompte: {}", e.getMessage(), e);
    ...
    public void deleteDecompte(Long numMarche, Long numPieceFourn) {
        try {
            ...
            logger.error("Erreur lors de la suppression du décompte: {}", e.getMessage(), e);
            throw new RuntimeException("Erreur lors de la suppression du décompte", e);
        }
    }
    ...
    public ResponseEntity<MessageResponse> envoyerDecompteAuFinancier(Long numMarche, Short numPieceFourn, String numStruct, String nomUser) {
        ...
        try (Connection connection = dataSource.getConnection();
             CallableStatement callableStatement = connection.prepareCall("{ call PKG_ENVOI.ENVOI_DECOMPTE(?, ?, ?, ?, ?) }")) {
            ...
            logger.error("Erreur lors de l'envoi du décompte au financier: {}", e.getMessage(), e);
    ...
    public boolean isDateDecompteValide(Long numMarche, Date datePiece) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            logger.error("Erreur lors de la vérification de la validité de la date du décompte: {}", e.getMessage(), e);
        }
